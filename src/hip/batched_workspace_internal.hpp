...
struct DeviceBatchJacobiStatistics {
  ...
  std::uint64_t csc_nonzero_runs_visited{};
...
static_assert(std::is_standard_layout_v<DeviceBatchJacobiView>);
static_assert(std::is_trivially_copyable_v<DeviceBatchJacobiView>);
static_assert(std::is_standard_layout_v<DeviceBatchJacobiStatistics>);
static_assert(std::is_trivially_copyable_v<DeviceBatchJacobiStatistics>);
